...
//    override fun insertLog(log: CaffeineLog) = dao.insertLog(log)
//    override fun getAllLogs(): Flow<List<CaffeineLog>> = dao.getAllLogs()
//}

class CaffeineRepositoryImpl(private val dao: CaffeineDao) : CaffeineRepository {
    override fun insertLog(log: CaffeineLog) {
        dao.insertLog(log)  // ← Direct call, no suspend
    }
